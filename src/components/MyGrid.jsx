        ...
        <div className={style.main}>
            <div className={style.grid}>
                <div className={style.card}>
                    ...
                    <br></br>Optio fugiat qui nam debitis doloremque esse at repellendus,
                    <br></br> obcaecati quisquam harum quaerat quas rem itaque ut cum! Eos quaerat pariatur voluptatem?.</p>
